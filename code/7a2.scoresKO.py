...
helper = Oracle_systematic_analysis_helper(hdf5_file_path="Systematic_KO_results_all.celloracle.hdf5")
...
ps_path1_pos.to_csv("KO_all_ps_path1_pos.csv")
ps_path1_pos
...
ps_path1_neg.to_csv("KO_all_ps_path1_neg.csv")
ps_path1_neg
